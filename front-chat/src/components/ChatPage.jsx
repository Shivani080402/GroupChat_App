...
const ChatPage = () => {
  ...
  return (
    <div className="">
      {/* this is a header */}
      <header className="dark:border-gray-700  fixed w-full dark:bg-gray-900 py-4 shadow flex justify-around items-center">
        {/* room name container */}
        <div>
          <h1 className="text-xl font-semibold">
          Group : <span>{roomId}</span>
          </h1>
        </div>
        {/* username container */}
      ...
      <main
        ref={chatBoxRef}
        className="py-20 px-10   w-2/3 dark:bg-[#23304b] mx-auto h-screen overflow-auto "
      >
        {messages.map((message, index) => (
          ...
          >
            <div
              className={`my-2 ${
                message.sender === currentUser ? "bg-green-900" : "bg-gray-800"
